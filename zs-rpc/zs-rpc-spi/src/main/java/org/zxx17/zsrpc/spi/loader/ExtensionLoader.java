package org.zxx17.zsrpc.spi.loader;
...
import org.zxx17.zsrpc.spi.factory.ExtensionFactory;
...
public class ExtensionLoader<T> {
    ...
    private static final String ZXX_DIRECTORY = "META-INF/zxx/";
    private static final String ZXX_DIRECTORY_EXTERNAL = "META-INF/zxx/external/";
    private static final String ZXX_DIRECTORY_INTERNAL = "META-INF/zxx/internal/";

    private static final String[] SPI_DIRECTORIES = new String[]{
            SERVICES_DIRECTORY,
            ZXX_DIRECTORY,
            ZXX_DIRECTORY_EXTERNAL,
            ZXX_DIRECTORY_INTERNAL
    };
